...
public class MeshOcclusionUIController : MonoBehaviour, ITangoLifecycle, ITangoPose
{
    ...
    public void Button_StartAreaDescriptionMesh()
    {
        ...
        // On cheat et on exporte le mesh qui correspond à l'area description
        //OBJExporter.ExportToOBJ(m_meshFromFile);
    }
    ...
    public void Button_ViewMesh()
    {
        ...
        //props.SetParent(m_meshFromFile.transform);
        //props.localPosition = Vector3.zero;
        //props.localRotation = Quaternion.identity;
